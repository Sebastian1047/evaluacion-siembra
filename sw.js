const CACHE='evaluacion-siembra-shell-v2';
const APP_SHELL=[
  ...
  './js/app.js?v=20260922-no-legacy-report','./js/monitor-current-ui.js?v=20260916-2','./js/offline-storage.js?v=20260923-2','./js/offline-bootstrap.js?v=20260923-3','./js/offline-readiness.js?v=20260923-1','./js/week-options.js','./js/empleados-reales.js',
