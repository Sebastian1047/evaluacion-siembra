...
(function(){
  const cols=[['c7','Aseo sitio de trabajo'],['c2','Distribución'],['c3','Estado de planta'],['c1','Planta inclinada'],['c4','Profundidad de la planta'],['c5','Selección de esquejes'],['c6','EPPS'],['c8','Acuerdos de oro'],['c9','Siembra con marcador'],['c10','Ubicación de mangueras'],['c11','Conteo de líneas'],['c12','Densidad']];
  let reportableWeeks=[];
  let reportRows=[];
  let loading=false;
  let loadError='';
